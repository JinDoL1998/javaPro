...
/**
 * @author jinseong
 * @date 2024. 2. 1. - 오후 3:41:24
 * @subject <? extends Fruit>
 * @content	
 */
public class Ex06_05 {
	...
	public static void main(String[] args) {
		...
		juice = Juicer.makeJuice(grapeBox);	// <Grape> 생략가능.
...
class Juicer{
	...
	*/
	...
	// 	ㄴ 선언 형식
	//	ㄴ 접근지정자 static <T> 리턴자료형 제네릭메서드명(매개변수){}
	...
	// Erasure of method makeJuice(FruitBox<Apple>) is the same as another method in type Juicer -> 매개변수같아서 오버로딩 불가
