...
public abstract class Employee {
	...
	public Employee(String name, String address, String tel, String hiredate) {
		this.name = name;
	...
	public void dispEmployeeInfo() {
		System.out.printf("사원명:%s, 주소:%s, 연락처:%s, 입사일자:%s\n", this.name, this.address, this.tel, this.hiredate);
	}

	@Override
	public String toString() {
		return "Employee [name=" + name + ", address=" + address + ", tel=" + tel + ", hiredate=" + hiredate + "]";
	}
